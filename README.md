...
<ul>
  <li><strong><a href="#catálogo">Catálogo</a></strong>: Gerenciamento de produtos.</li>
  <li><strong><a href="#cesta">Cesta</a></strong>: Operações de carrinho de compras.</li>
  <li><strong><a href="#desconto">Desconto</a></strong>: Aplicação de cupons e promoções.</li>
  <li><strong><a href="#pedidos">Pedidos</a></strong>: Processamento e gerenciamento de pedidos.</li>
